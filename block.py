...
class LSKA(nn.Module):
    def __init__(self, c1, c2):
        super().__init__()
        self.conv0h = nn.Conv2d(c1, c2, kernel_size=(1, 5), padding=(0, 2), groups=1)
        self.conv0v = nn.Conv2d(c2, c2, kernel_size=(5, 1), padding=(2, 0), groups=1)
...
class SPPF_CA(nn.Module):
    ...
    def __init__(self, c1, c2, n, k=5):
        ...
        self.dwconv_h = nn.Conv2d(c_, c_, kernel_size=(1,5), padding='same', groups=c_) #變成直的一條
        self.dwconv_w = nn.Conv2d(c_, c_, kernel_size=(5,1), padding='same', groups=c_ )
    ...
    def forward(self, x):
        ...
        for i in range(self.n):
            ...
            ca_output = self.ca(dwconv_output) #得到注意力圖
